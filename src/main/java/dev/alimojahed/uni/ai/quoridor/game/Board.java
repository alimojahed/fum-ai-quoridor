...
import dev.alimojahed.uni.ai.quoridor.player.Player;

import java.util.*;

public class Board {

    public int ROWS_NUM = 9;
    public int COLS_NUM = 9;

    public Set<Set> map = new HashSet<Set>();
    public Piece[][] boardMap = new Piece[ROWS_NUM][COLS_NUM];
    public HashMap<Piece, Piece> paired_block_pieces  = new HashMap<Piece, Piece>();
